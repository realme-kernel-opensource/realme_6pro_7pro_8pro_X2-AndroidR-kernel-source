...
extern int oppo_register_dhall(const char *name,
			       struct oppo_dhall_operations *ops);
extern int oppo_unregister_dhall(const char *name);
extern int oppo_register_motor(const char *name,
			       struct oppo_motor_operations *ops);
...
extern bool oppo_dhall_update_threshold(unsigned int id, int position,
					short thresh);
