...
#define ACM_OPT_UNLINK 10
#define ACM_OPT_RMDIR 11
#define ACM_OPT_MKNOD 8
#define ACM_OPT_CRTEAT 35
#define ACM_OPT_MKDIR 9
#define ACM_OPT_RENAME 12
#define ACM_OPT_RENAME2 45
